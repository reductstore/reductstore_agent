...
def test_recorder_lifecycle():
    ...
    try:
        param_overrides = [
            ...
            Parameter(
                "pipelines.telemetry.include_topics",
                Parameter.Type.STRING_ARRAY,
                ["/recorder/input"],
            ),
            Parameter(
                "pipelines.telemetry.split.max_duration_s", Parameter.Type.INTEGER, 5
            ),
            Parameter(
                "pipelines.telemetry.split.max_size_bytes", Parameter.Type.INTEGER, 100
            ),
        ]
